...
class RolloutBuffer(BaseBuffer):
    ...
    def reset(self) -> None:
        ...
        self.generator_ready = False
        # Intuition specific terms
        self.action_triggers = np.zeros((self.buffer_size, self.n_envs), dtype=np.float32)
        #
        super().reset()
    ...
    def add(
        ...
        #
        self.action_triggers[self.pos] = False
        self.pos += 1
        if self.pos == self.buffer_size:
            self.full = True
    ...
    def _get_samples(
        ...
        data = (
            ...
            self.action_triggers[batch_inds].flatten(),
        )
