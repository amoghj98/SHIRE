...
python intuitiveTrain.py -a ppo --env Swimmer-v4 -bsz 4 -e 10 -lr 5e-4 1e-4 5e-5 -lrs 200000 400000 1000000 -cr 0.2 -crs 1000000  --totalSteps 1000000 -ef 5000 --nCores 4 # --intuitiveEncouragement -icf 1.0 -ist 100.0
# python intuitiveTrain.py -a ppo --env Swimmer-v4 -bsz 4 -e 10 -lr 1e-4 1e-2 5e-3 1e-3 1e-4 -lrs 80000 200000 300000 400000 1000000 -cr 0.2 0.3 -crs 80000 1000000 --beta 0.3 0.0 --beta-schedule 80000 1000000 --totalSteps 1000000 -ef 5000 --nCores 4 --intuitiveEncouragement -icf 1.0 -ist 100.0
#
