...
CUDA_VISIBLE_DEVICES=$CARD python intuitiveTrain.py -a ppo --env Maze-v0 -bsz 16 -e 5 -ns 1024 -lr 1e-4 -lrs 1000000 -cr 0.3 -crs 1000000 --totalSteps 1000000 -ef 20000 --gamma 0.99 --nCores 8 -ssr 1.0
#
