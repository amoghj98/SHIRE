...
# python intuitiveTrain.py -a dqn --env CartPole-v1 -ns 5000 -bsz 512 -e 80 --tau 0.0005 --gamma 0.9 -lr 4e-4 -lrs 100000 -cr 0.5 -crs 100000 --totalSteps 2000000 -ef 20000 --nCores 2 -ssr 195.0 --set-seeds --seed-file-dir 091024123208 --intuitiveEncouragement -icf 1e-6 -ist 195.0
...
# CUDA_VISIBLE_DEVICES=$CARD python intuitiveTrain.py -a ppo --env Ant-v4 -bsz 16 -e 5 -ns 4096 -lr 1e-4 5e-5 1e-5 5e-6 1e-6 -lrs 50000 500000 2500000 10000000 40000000 -cr 0.3 -crs 10000000  --totalSteps 80000000 -ef 100000 --beta 0.01 0.0 --beta-schedule 1000000 80000000 --lambd 0.98 --gamma 0.995 --nCores 8 -ssr 6000.0 --set-seeds --seed-file-dir 071524105033 --intuitiveEncouragement -icf 150 -ist 6000.0
# CUDA_VISIBLE_DEVICES=$CARD python intuitiveTrain.py -a ppo --env Taxi-v3 -bsz 16 -e 10 -ns 1024 -lr 5e-4 3e-4 1e-4 5e-5 -lrs 500000 1500000 2500000 4000000 -cr 0.3 -crs 4000000 --totalSteps 4000000 -ef 5000 --beta 0.06 0.0 --beta-schedule 100000 4000000 --lambd 0.98 --gamma 0.99 --nCores 4 -ssr 8.0 --set-seeds --seed-file-dir 081324232412 #--intuitiveEncouragement -icf 3.0 -ist 8.0
# CUDA_VISIBLE_DEVICES=$CARD python intuitiveTrain.py -a ppo --env Maze-v0 -bsz 8 -e 10 -ns 1024 -lr 1e-4 1e-5 -lrs 800000 10000000 -cr 0.2 -crs 1000000 --totalSteps 10000000 -ef 20000 --beta 0.02 0.0 --beta-schedule 100000 1000000 --gamma 0.99 --nCores 8 -ssr 1.0
#
...
# python intuitiveTrain.py --env Taxi-v3 --mode test -nep 2 --loadPath ./best_model/081424104418