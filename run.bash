...
CUDA_VISIBLE_DEVICES=$CARD python intuitiveTrain.py -a ppo --env Ant-v4 -bsz 16 -e 10 -ns 1024 -lr 1e-4 5e-5 1e-5 5e-6 1e-6 -lrs 50000 500000 2500000 10000000 50000000 -cr 0.3 -crs 10000000  --totalSteps 80000000 -ef 100000 --beta 0.005 0.0 --beta-schedule 500000 10000000 --lambd 0.98 --gamma 0.995 --nCores 16 -ssr 6000.0 --set-seeds --seed-file-dir 071924145148 # --intuitiveEncouragement -icf 100 -ist 2000.0
#
